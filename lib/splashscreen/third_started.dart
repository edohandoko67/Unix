...
class _ThirdStartedState extends State<ThirdStarted>
  ...
  void initState() {
    ...
    _fadeInAnimations = Tween<double>(begin: 0, end: 1.2).animate(
      CurvedAnimation(parent: _animationControllers, curve: Curves.easeIn),
    );
                      ...
                      Container(
                          ...
                          child: Padding(
                            ...
                            child: Align(
                              alignment: Alignment.center,
                              child: Text(
                                'Wallfam mungkin memerlukan izin tambahan untuk memberi tahu Anda tentang pencatatan keuangan',
                        ...
                        child: FadeTransition(
                          ...
                          child: ElevatedButton(
                            style: ButtonStyle(
                                ...
                                minimumSize:
                                    MaterialStateProperty.all(Size(290, 51))),
                            onPressed: () {
                              // Navigator.push(
